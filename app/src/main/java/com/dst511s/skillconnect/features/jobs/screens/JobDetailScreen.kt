...
import com.dst511s.skillconnect.components.layout.BulletList
...
fun JobDetailScreen(
    ...
    val job = remember {
        when (jobId) {
            "1" -> com.dst511s.skillconnect.core.data.models.job.JobDetail(
                id = "1",
            ...
            else -> com.dst511s.skillconnect.core.data.models.job.JobDetail(
                id = jobId,
                title = "Unknown Job",
